    ...
    if (y(i) == k) 
      ...
      y(i,k) = 1;
        ...
        delta3 = h - y;
         #5000*10
         25*5000* 5000*401
        delta2 =  (delta3 * Theta2(:,2:end)) .* sigmoidGradient(a * Theta1');
        10*5000 * 5000*26
         ...
         #Theta1 : 25 * 401
         #Theta2 : 10 * 26
        Theta1(:,1) = 0;  % for regularization so that we don't include the bias
        Theta2(:,1) = 0;  
        Theta1_grad = Theta1_grad + (a' *  delta2)';
        Theta1_grad = 1/m * Theta1_grad + lambda/m * Theta1;
         #25*401                401*5000  * 5000 *25      401*25    '''
        Theta2_grad = Theta2_grad + (a2' * delta3)';
        Theta2_grad = 1/m * Theta2_grad + lambda/m * Theta2;
         #10*26                 26*5000 * 5000*10   '''
